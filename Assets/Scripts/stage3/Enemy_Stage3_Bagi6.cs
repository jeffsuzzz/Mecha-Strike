...
public class Enemy_Stage3_Bagi6: MonoBehaviour {
	...
	void Update () {
        if (active)
        {
            ...
            if (this.transform.position.z < 1980)
            {
                this.transform.position = new Vector3(this.transform.position.x, this.transform.position.y, 1980);
                forward = false;
            }
            if (this.transform.position.z > 2300)
            {
                this.transform.position = new Vector3(this.transform.position.x, this.transform.position.y, 2300);
                forward = true;
            }
