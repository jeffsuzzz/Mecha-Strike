...
public class Enemy_Stage3_Bagi4 : MonoBehaviour {
	...
	void Update () {
        if (active)
        {
            ...
            if (this.transform.position.z < 600)
            {
                this.transform.position = new Vector3(this.transform.position.x, this.transform.position.y, 600);
                forward = false;
            }
            if (this.transform.position.z > 1150)
            {
                this.transform.position = new Vector3(this.transform.position.x, this.transform.position.y, 1150);
                forward = true;
            }
