...
public class Enemy_Stage3_Bagi1 : MonoBehaviour {
	...
	void Update () {
        if (active)
        {
            float dir = target.transform.position.z - this.transform.position.z;
            if ( Mathf.Abs(dir) > 5) {
                if (dir > 0)
                {
                ...
                if (this.transform.position.z > -105)
                    this.transform.position =  new Vector3(this.transform.position.x, this.transform.position.y, -105);
                if (this.transform.position.z < -450)
                    this.transform.position = new Vector3(this.transform.position.x, this.transform.position.y, -450);
            ...
            if (Time.time > startTime+2.0f) active = true;
        }
